...
## This bash script takes a folder of car and mdf files, then preps everything for simulations. 
## Useful for many structures with the same simulation parameters
...
##	3) Edit Slurm array job script to have the correct numbers for array
